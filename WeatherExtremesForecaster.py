...
# Function to fetch and display weather data for extreme cities in India
def WeatherExtremesForecaster():
    url = "https://www.weather-forecast.com/maps/India"  # URL of the weather forecast website for India
    ...
    # Extract and store temperatures
    ...
    # Extract and store city names, matching the number of temperatures
    ...
    return dataSheet  # Return the DataFrame containing the weather data
